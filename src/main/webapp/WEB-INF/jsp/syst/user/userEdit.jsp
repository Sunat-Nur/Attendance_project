	...
	<div id="pageContent"> 
		<div class="userEdit">
			<h2>User Details Edit</h2>
     		...
     		<form id="userDetailsForm" action="updateUserDetails.do" method="post" enctype="multipart/form-data">
...
$(document).ready(function() {
 ...
 // Function to extract URL parameters
    ...
    $('#cancelButton').click(function(event) {
        ...
        window.location.href = 'userDetails.do?empId=' + empId; // Redirect to userDetails.do with empId parameter
    });
    ...
    function deleteFiles(filesToDelete) {
        if (filesToDelete.length > 0) { // Ensure there are files to delete
            ...
            $.ajax({
                ...
                success: function(response) {
                    var empId = $('#empId').val();
                    window.location.href = 'userDetails.do?empId=' + encodeURIComponent(empId);
                },
                error: function(xhr, status, error) {
