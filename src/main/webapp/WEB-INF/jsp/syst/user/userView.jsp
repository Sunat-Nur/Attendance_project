...
<h2>User Details</h2>
  ...
  <div class="form-buttons">
   <form action="editUserDetails.do" method="get" style="display: inline;">
       <input type="hidden" name="empId" value="${userDetails.empId}" />
       <button type="submit">Edit</button>
   </form>

   <form id="deleteUserForm" action="deleteUser.do" method="post" style="display: inline;">
       <input type="hidden" name="empId" value="${userDetails.empId}">
            ...
            <c:otherwise>
                <c:forEach var="file" items="${contractFiles}">
                    <div style="margin-bottom: 5px;">
                        ...
                        <a href="downloadFile.do?fileNo=${file.no}"><i class="fa-solid fa-download" style="color: #3861a8;"></i></a>
                    </div>
                </c:forEach>
            </c:otherwise>
        </c:choose>
