...
<head>
    ...
    <!-- FixedColumns Extension CSS and JS -->
    <link rel="stylesheet" href="https://cdn.datatables.net/fixedcolumns/3.3.0/css/fixedColumns.dataTables.min.css">
    <script src="https://cdn.datatables.net/fixedcolumns/3.3.0/js/dataTables.fixedColumns.min.js"></script>

    <!-- Additional libraries and stylesheets -->
...
$('#endDatePicker').datepicker({
   ...
   $('input[type="checkbox"][onchange*="toggleColumn"]').on('change', function() {
    ...
    var securityLevel = ${loggedInUser.securityLevel};


    if (securityLevel > 6 ) {
        // Hide the Work Type and Access Type search boxes
        $('#workTypeSearchBox').hide();
        $('#accessTypeSearchBox').hide();
        // Optionally, you could also hide the labels/spans associated with these inputs
        $('span:contains("Work Type:"), span:contains("Access Type:")').hide();
    }
